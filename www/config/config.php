 ...
 * Настройки HTML вида
 */
$config['view']['skin']        = '1inkz';                                                              // шаблон(скин)
$config['view']['name']        = 'Блоги на Первом Казахстанском';                   // название сайта
$config['view']['description'] = 'Блоги на Первом Казахстанском'; // seo description
$config['view']['keywords']    = 'движок, казахстан, блоги, социальная сеть, бесплатный, php';      // seo keywords
...
$config['sys']['mail']['from_email']       = 'info@blogs.1in.kz';    // Мыло с которого отправляются все уведомления
$config['sys']['mail']['from_name']        = 'Блоги на Первом Казахстанском';  // Имя с которого отправляются все уведомления
...
$config['acl']['create']['topic']['limit_time']           =  0;// время в секундах между созданием записей, если 0 то ограничение по времени не будет работать 
...
$config['module']['comment']['max_tree'] = 3;           // Максимальная вложенность комментов при отображении
// Модуль Talk
...
$config['block']['rule_search'] = array(
	'action'  => array( 'search' => array('topics','comments') ),
	'blocks'  => array( 'right' => array('actions/ActionSearch/sidebar.tpl') ),
);
...
$config['head']['default']['js']  = array(
    ...
    "___path.static.skin___/js/ext/jquery-1.2.6.min.js",
    "___path.static.skin___/js/ext/easySlider1.7.js",
    "___path.static.skin___/js/ext/jquery-fonteffect-1.0.0.js",
    "___path.static.skin___/js/ext/jquery.hoveraccordion.js",
    "___path.static.skin___/js/ext/jquery.jcarousel.pack.js",
    "___path.static.skin___/js/ext/jquery.corner.js",
    "___path.static.skin___/js/ext/1in.kz.js",
);
...
//    "___path.static.skin___/css/ext/main.css?v=1",
);
