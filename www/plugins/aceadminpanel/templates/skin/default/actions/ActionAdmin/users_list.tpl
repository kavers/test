...
{if $aUserList}
{include file="$sTemplatePath/paging.tpl" aPaging=`$aPaging`}
<table class="admin-table">
	...
	{if $sMode=='admins'}
        <td class="center">
            ...
            <a href="{router page='admin'}users/admins/{$oUser->getLogin()}/del/?security_ls_key={$LIVESTREET_SECURITY_KEY}" class="link">{$oLang->adm_exclude}</a>&nbsp;
            {/if}
        </td>
	{else}
