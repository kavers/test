        ...
        <div class="block_content">
          <div id="text">
			<form action="" method="POST" enctype="multipart/form-data">
             ...
             <div class="right_text settings">
               <div id="add_book_format">
				<p>
					{$aLang.settings_profile_name}:
					<input class="line" type="text" name="profile_name" id="profile_name" value="{$oUserCurrent->getProfileName()|escape:'html'}" class="w100p" />
					<strong>{$aLang.settings_profile_name_notice}</strong>
				</p>
				<p>
					{$aLang.settings_profile_mail}:
					<input class="line" type="text" class="w100p" name="mail" id="mail" value="{$oUserCurrent->getMail()|escape:'html'}"/>
					<strong class="form_note">{$aLang.settings_profile_mail_notice}</strong>
				</p>
				<p>
				...
				<p>
					{$aLang.settings_profile_birthday}:<br />					
				...
				<p>
					{$aLang.settings_profile_country}:
                    <input type="text" class="line" 	id="profile_country" name="profile_country" value="{$oUserCurrent->getProfileCountry()|escape:'html'}"/><br />
					{$aLang.settings_profile_city}:
                    <input type="text" class="line" id="profile_city" name="profile_city" value="{$oUserCurrent->getProfileCity()|escape:'html'}"/>
				</p>
				
				<p>
                    {$aLang.settings_profile_icq}:
                    <input type="text" class="line" name="profile_icq" id="profile_icq" value="{$oUserCurrent->getProfileIcq()|escape:'html'}"/>
                </p>
				
				<p>
					{$aLang.settings_profile_site}:
					<input type="text" class="line" style="margin-bottom: 5px;" id="profile_site" name="profile_site" value="{$oUserCurrent->getProfileSite()|escape:'html'}"/>
                    <strong>{$aLang.settings_profile_site_url}</strong>
					<input type="text" class="line" id="profile_site_name"	name="profile_site_name" value="{$oUserCurrent->getProfileSiteName()|escape:'html'}"/>
                    <strong>{$aLang.settings_profile_site_name}</strong>
				</p>
				
				<p>
					{$aLang.settings_profile_about}:
					<textarea class="area" name="profile_about" id="profile_about">{$oUserCurrent->getProfileAbout()|escape:'html'}</textarea>
				</p>
				
				<p>
					{$aLang.settings_profile_password_current}:
                    <input type="password" class="line" name="password_now" id="password_now" value=""/>
					{$aLang.settings_profile_password_new}:
                    <input type="password" class="line" id="password"	name="password" value=""/>
					{$aLang.settings_profile_password_confirm}:
                    <input type="password" class="line" id="password_confirm"	name="password_confirm" value=""/>
				</p>
				...
				<p>
                    ...
                    <input class="line" type="file" id="avatar" name="avatar"/></p>
				...
				{/if}
				<p>
                    {$aLang.settings_profile_foto}:
                    <input class="line" type="file" id="foto" name="foto"/></p>
				
				{hook run='form_settings_profile_end'}
                <input type="hidden" name="submit_profile_edit" value="1">
                <p class="cn refill"><input  type="image" src="{cfg name='path.static.skin'}/img/save_button.gif" width="212" height="32" alt="{$aLang.settings_profile_submit}" title="{$aLang.settings_profile_submit}"/></p>
