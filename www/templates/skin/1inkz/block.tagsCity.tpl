{if $aCityList && count($aCityList)>0}
    <li id="about_author" class="block pine_green">
        <div class="title"><a href="#111" class="link"><h1>{$aLang.block_city_tags}</h1></a><a href="#" class="close_block"><img src="/img/minus.gif" width="18" height="18" alt="Свернуть блок" title="Свернуть блок"/></a></div>
