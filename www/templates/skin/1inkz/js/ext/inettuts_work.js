                ...
                $('<a href="#" class="collapse"></a>').mousedown(function (e) {
                    ...
                    $(this).css({backgroundPosition: 'right'})
                        .parents(settings.widgetSelector)
                            ...
                            $(this).parent().css({background: 'URL('+DIR_STATIC_SKIN + '/img/title_fon2.png)'});
                            $(this).parent().addClass('white');
							$(this).next().find('.JQFEText').next().hide();
                    return false;
                },function () {
                    $(this).css({backgroundPosition: 'left'})
                        .parents(settings.widgetSelector)
                            .find(settings.contentSelector).show();
                            $(this).parent().css({background: 'URL('+DIR_STATIC_SKIN + '/img/title_fon.png)'});
                            $(this).parent().removeClass('white');
							$(this).next().find('.JQFEText').next().show();
                    return false;
