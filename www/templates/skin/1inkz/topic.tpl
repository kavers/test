...
{$oTopic->getText()}
           ...
           <ul class="add_icons dream_icons">
			 ...
			 <!--
			 <a href="" class="more_menu2 close"><img src="{cfg name='path.static.skin'}/img/icon4.png" width="44" height="44" alt="Отправить другу" title="Отправить другу"/>Отправить другу</a>
